  ...
  @endif
    <form action="" method="POST" role="form">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="TitlePage" placeholder="Tiêu đề trang">
      </div>
      <div class="form-group">
        <label for="">Tên đầy đủ của trang </label>
        <input type="text" class="form-control" name="TenPage" placeholder="Tên trang">
      </div>
      <div class="form-group">
        <label for="">Nội Dung</label>
        <textarea name="NoiDung" placeholder="Nội dung" id="textarea" class="form-control"></textarea>
        <script>
